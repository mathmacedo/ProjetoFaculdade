...
public class CadastrarUsuarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request,
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<ul class='col-md-6 offset-md-3'>");
            out.println("<li class='list-group-item'> Nome : " + novoUsuario.getNome() + "</li>");
            out.println("<li class='list-group-item'> Login : " + novoUsuario.getLogin() + "</li>");
            out.println("<li class='list-group-item'> Senha : " + novoUsuario.getSenha() + "</li>");

            try {
                novoUsuarioDAO.inserirUsuario(novoUsuario);
            } catch (Exception e) {
                System.out.println("Erro" + e);
            }
            out.println("</ul>");
            out.println("<div><a class='btn btn-primary col-md-6 offset-md-3' href='/Exercicio4Web2/portal.jsp' role='button'>Voltar</a></div>");
